...
// from https://github.com/freesewing/.../models/src/index.mjs#L4
// from https://github.com/freesewing/.../neckestimate.mjs
export const getMeasurements = (size, index) => {
    const all = {}
    for (const m of measurements) {
      //all[m] = neckstimate(size * 10, m, index)
          all[m] = neckstimate(size, m, index)
    }
  ...
  export const cisFemaleAdult34 = getMeasurements(340, CISFEMALE)